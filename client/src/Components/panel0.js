				...
				<div className="container">
					...
					<div className="row">
						<div className="col-md-4 seth1">
							<div className="key1">
								<img src="./images/bill1.png" alt='img' className="imgsizee" />
							</div>
							<div className="init2">
						...
						<div className="col-md-4 text-center">
							<div className="key1">
								<img src="./images/bill2.png" alt='img' className="imgsizee" />
							</div>
							<div className="init6">
								<div style={{ color: 'white' }}>
						...
						<div className="col-md-4 seth2">
							<div className="key1">
								<img src="./images/bill3.png" alt='img' className="imgsizee" />
							</div>
							<div className="init7">
								<div style={{ color: 'white' }}>
