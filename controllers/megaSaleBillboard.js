...
exports.postmegaSaleBillboard = function(req,res,next){
  ...
  const postBillboardData = new megaSaleBillboard({
    ...
    percantageOfDisscount:formData.percantageOfDisscount,
    billboardAvaliableStartDate:formData.billboardAvaliableStartDate,
    billboardAvaliableEndDate:formData.billboardAvaliableEndDate,
