					...
					<div className="row">
						<div className="col-12 col-md-4 col-lg-4 col-xl-4">
							<div class="card_bidding">
								<img class="card-img-top" src="./images/bill1.png" alt="Card image" style={{ width: '100%' }} />
								<div class="card-body">
						...
						<div className="col-12 col-md-4 col-lg-4 col-xl-4">
							<div class="card_bidding">
								<img class="card-img-top" src="./images/bill2.png" alt="Card image" style={{ width: '100%' }} />
								<div class="card-body">
