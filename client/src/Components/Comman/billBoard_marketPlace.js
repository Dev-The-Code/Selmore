				      		...
				      		<div className="col-md-4 seth1">
				      			...
				      			<div className="init2">
				      				<div style={{color: 'white'}}>
						      			...
						      			<p className="fanta2"><button type="button" className="btn btn-primary fanta3"><Link  rel="noopener noreferrer" to={`/billborad_Militry`} style={{color:"white"}}>BIDDING</Link></button></p>
					      			</div>
		      					</div>
				      		</div>
                        )
